/*
Lector de archivos CSV en C++
    https://parzibyte.me/blog/
*/
#include <iostream>
#include <sstream>
#include <fstream>
#define NOMBRE_ARCHIVO "Tabla_de_contenidos.csv"
using namespace std;
...
int main()
{
    ...
    while (getline(archivo, linea))
    {
        ...
        string idProducto, codigoBarras, descripcion, precioCompra, precioVenta, existencia, stock, color;
